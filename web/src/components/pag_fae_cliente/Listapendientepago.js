...
const url = "http://localhost:3000/usuario/datareservawebpendientepago/";
const urlPutreserva = "http://localhost:3000/reserva/update/";

function Listapendientepago() {
    ...
    return (
        <div>
            <br/>
            <p style={{ fontSize: "30px", textAlign: "center", color: "black" }}>Listado de reservas pendientes de pago</p>
            <div align="center">
            <Row>
            ...
            <div align="right">
                ...
                </div>} filename="Excel reservas pendientes de pago">
                    <ExcelSheet data={reservas} name="Reservas comedor pendientes de pago">
...
export default Listapendientepago;